...
<body>
        ...
        <div class="container">
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <asp:Button ID="btPassRec" runat="server" CssClass="btn btn-success" Text="Send" OnClick="btPassRec_Click" />
    ...
    <footer>
        <div class="container">
            ...
            <p>&copy; 2015 eShopNepal &middot; <a href="Default.aspx">Home</a> &middot; <a href="#">About</a> &middot; <a href="#">Contact</a> &middot; <a href="#">Products</a></p>
        </div>
    </footer>
