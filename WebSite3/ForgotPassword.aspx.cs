        ...
        using (SqlConnection con = new SqlConnection(CS))
        {
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                try
                {
                    ...
                    String EmailBody = "Hi " + Username + ",<br/><br/> Click the link below to reset your password <br/><br/> http://localhost:53271/RecoverPassword.aspx?Uid=" + myGUID;
                    MailMessage PassRecMail = new MailMessage("santoshKhadka423@gmail.com", ToEmailAddress);
                    ...
                    SMTP.EnableSsl = true;
                    NetworkCredential NetworkCred = new NetworkCredential(ToEmailAddress, Password);
                ...
                {
                    Response.Write("error in sending messge" + ex.Message);
                }
