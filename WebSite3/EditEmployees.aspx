<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeFile="EditEmployees.aspx.cs" Inherits="EditEmployees" %>
    ...
    <div class="container">
        <div class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <asp:Button ID="btnAdd" runat="server" Text="UPdate" CssClass="btn btn-default" OnClick="btnAdd_Click"  />
                </div>
            </div>
             <div class="form-group">
                <div class="col-md-2"></div>
